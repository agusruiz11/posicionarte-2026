  ...
  return {
    ...
    transformIndexHtml() {
      ...
      const ALLOWED_PARENT_ORIGINS = [
          "https://posicionarte.online",
          "https://posicionarte.online.dev",
          "https://posicionarte-frontend-local.posicionarte.online.dev",
      ];

        // Check to see if the page is in an iframe
        if (window.self !== window.top) {
          const STORAGE_KEY = 'posicionarte-iframe-saved-route';
